...
import br.com.gomes.daniel.ufabc.alertadematricula.matriculagerenciadordemensagens.framework.framework.repositoriosImpl.servicos.SQL.Criptogrador;
...
public class EnviarMensagemNotificarCadastradosImpl implements EnviarMensagemNotificarCadastrados {
    ...
    public void enviar(Mensagem<NotificarCadastrado> notificarCadastradoMensagem) {
        ...
        log.info("Foi realizada a notificacao para o usuario " + Criptogrador.paraSha256(notificarCadastradoMensagem.getConteudo().getDestinatario())  + " para a disciplina " + notificarCadastradoMensagem.getConteudo().getDisciplina().getNome() + "foi enviada para a fila " + notificarCadastradoMensagem.getFila());
    }
